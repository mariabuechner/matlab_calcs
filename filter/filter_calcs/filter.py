...
#    parameters['spectrum_range'] = None
    ...
    parameters['curved_detector'] = False
    parameters['distance_source_detector'] = 1093  # [mm]
    parameters['number_phase_steps'] = 31.0
    parameters['material_sample'] = 'C5H8O2'  # PMMA
    parameters['sample_distance'] = 517  # [mm]
    parameters['thichness_sample'] = 30.0  # [mm]
...
#    sigma_0 = 0.93802246451191473  # with positive mu..., 30-82keV, correct vis calc
    ...
    sigma_0 = 0.15658923091356702  # 3mm, 30-82keV, correct vis calc
 ...
 ########### Optimize filter
    ...
    sample_thicknesses = sample_thicknesses[24::25]  # [mm]
    thetas = thetas[24::25]  # [rad]
...
#        solver = 'COBYLA'  # COBYLA or SLSQP
        # inequal contratings: means must be non-negative! (COBYLA only works with ineq!)
        args = (parameters, sigma_0, sample_thickness)
        constraints = {'type': 'ineq', 'fun': constraint_mean_energy,
...
#                           options={'eps': 1.0, 'ftol': 10e-2, 'maxiter': 10})
    ...
    scipy.io.savemat('3mm-results_rad_24_25-step_30_82-keV', all_results)


######## Spectrum development
##    results = scipy.io.loadmat('filter_sample_thicknesses.mat')
#    results = scipy.io.loadmat('results_rad_49_50-step_30_82-keV.mat')
